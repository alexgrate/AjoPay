...
export const allGroups = [
    // joined / active
    {
        id: 1, name: "Lagos Hustlers Circle", desc: "For young professionals in Lagos saving for business capital",
        members: 10, maxMembers: 10, contribution: "₦50,000", frequency: "Monthly",
        creator: "Adeola K.", iconBg: "#d4a843", status: "active", joined: true, fillPct: null,
        accentColor: "#d4a843",
    },
    {
        id: 2, name: "Tech Bros Savings", desc: "Tech professionals saving for gadgets and investments",
        members: 8, maxMembers: 8, contribution: "₦100,000", frequency: "Monthly",
        creator: "Chidi O.", iconBg: "#e8863a", status: "active", joined: true, fillPct: null,
        accentColor: "#e8863a",
    },
    {
        id: 3, name: "Market Women Alliance", desc: "Supporting market women with rotating capital",
        members: 15, maxMembers: 15, contribution: "₦30,000", frequency: "Monthly",
        creator: "Mama Ngozi", iconBg: "#7c5cbf", status: "active", joined: true, fillPct: null,
        accentColor: "#7c5cbf",
    },
    // available / pending
    {
        id: 4, name: "Abuja Young Professionals", desc: "Saving for rent and major expenses",
        members: 8, maxMembers: 12, contribution: "₦75,000", frequency: "Monthly",
        creator: "Funmi A.", iconBg: "#1db893", status: "pending", joined: false, fillPct: 67,
        accentColor: "#1db893",
    },
    {
        id: 5, name: "University Friends Circle", desc: "Alumni group saving for reunions and investments",
        members: 15, maxMembers: 20, contribution: "₦40,000", frequency: "Monthly",
        creator: "Tunde B.", iconBg: "#e84393", status: "pending", joined: false, fillPct: 75,
        accentColor: "#e84393",
    },
    {
        id: 6, name: "Fitness Enthusiasts Fund", desc: "Gym members saving for equipment and supplements",
        members: 6, maxMembers: 10, contribution: "₦25,000", frequency: "Weekly",
        creator: "Kemi S.", iconBg: "#2d9a4a", status: "pending", joined: false, fillPct: 60,
        accentColor: "#2d9a4a",
    },
];